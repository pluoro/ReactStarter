...
describe('reducer.js injectors', () => {
  ...
  describe('injectReducer helper', () => {
    ...
    it("should validate a reducer.js and reducer.js's key", () => {
      expect(() => injectReducer('', reducer)).toThrow();
      expect(() => injectReducer(1, reducer)).toThrow();
      expect(() => injectReducer(1, 1)).toThrow();
    });

    it('given a store, it should provide a function to inject a reducer.js', () => {
    ...
    it('should not assign reducer.js if already existing', () => {
    ...
    it('should assign reducer.js if different implementation for hot reloading', () => {
      store.replaceReducer = jest.fn();
      injectReducer('test', reducer);
